...
@section('content')
    ...
    <div class="card main">
        ...
        <div class="card-body">
            <form id="edit-form" action="{{route('admin.plat.update')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <div class="react-wysiwyg"
                                 ...
                                 data-value='@json(old('description') ?? $plat->description)'
                            ></div>
                        </div>
                    </div>
                </div>
                    ...
                    @foreach($plat->images as $image)
                        <div class="col-md-4 mt-3">
                            <div class="position-relative">
                                ...
                                <a href="{{route('admin.image.delete', $image->id)}}" class="btn btn-sm btn-danger position-absolute" style="top:5px;right:5px;"><i class="fa fa-times"></i></a>
                            </div>
                        </div>
                    @endforeach
                </div>
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-md-12 text-end">
                    <a href="{{route('admin.plat.index')}}" class="btn btn-sm btn-secondary">Retour</a>
